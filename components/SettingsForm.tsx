...
const SettingsForm: React.FC<SettingsFormProps> = ({ profile, onSave, onLogout, onManageSubscription, showBilling = true }) => {
  ...
  return (
    <form id="settings-form" onSubmit={handleSubmit} className="p-1 sm:p-2 space-y-2 pb-20">
      ...
      {/* Plan Status Card */}
      <div className="bg-gradient-to-br from-indigo-600 to-blue-700 rounded-xl p-3 text-white shadow-md relative overflow-hidden">
        <Zap className="absolute -right-6 -bottom-6 text-white/10 w-20 h-20" />
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-2.5">
          
          {/* Left info side */}
          <div className="space-y-1">
            <div className="flex items-center gap-1.5 flex-wrap">
              <span className="bg-white/20 px-1.5 py-0.5 rounded text-[8px] font-black tracking-widest uppercase">
                SaaS
              </span>
